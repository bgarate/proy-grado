...
\begin{DoxyParams}{Parameters}
{\em chan} & ID of the current channel. This allows to parse different channels with this function. a channel is not a physical message channel like a serial port, but a logic partition of the bodySocket streams in this case. C\+O\+M\+M\+\_\+\+NB is the limit for the number of channels on M\+CU (e.\+g. A\+R\+M7), while C\+O\+M\+M\+\_\+\+N\+B\+\_\+\+H\+I\+GH is the limit for the number of channels in Linux/\+Windows \\
\hline
