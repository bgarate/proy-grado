...
class OrbSlam2 : public BodyTest {
    ...
    void InitBodyTest(Hal *hal, VisualDebugger* visualDebugger) override {
        ...
        const std::string voc = "/home/bruno/proy-grado/lib/ORB_SLAM2/Vocabulary/ORBvoc.txt";
        const std::string settings ="/home/bruno/proy-grado/lib/ORB_SLAM2/Examples/Monocular/TUM1.yaml";
