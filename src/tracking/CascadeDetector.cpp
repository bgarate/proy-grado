...
void CascadeDetector::detect(std::shared_ptr<cv::Mat> frame) {
    ...
    cascade.detectMultiScale(resizedFrame, found, 1.05, 14, 0, cv::Size(20,60),cv::Size(400,1200));
    ...
    //cascade.detectMultiScale(resizedFrame, found, 2, 4, 0, cv::Size(40,120),cv::Size(400,1200));
