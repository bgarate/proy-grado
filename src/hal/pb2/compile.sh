sudo ldconfig
g++ -std=c++11 -c pb2haltest.cpp -o pb2haltest.o -Iinclude `pkg-config opencv --cflags --libs`
g++ -std=c++11 -c pb2hal.cpp -o pb2hal.o -Iinclude `pkg-config opencv --cflags --libs`
