...
g++ -std=c++11 -DNON_MATLAB_PARSING -DMAX_EXT_API_CONNECTIONS=255 -D__linux -c vrephaltest2.cpp -o vrephaltest2.o `pkg-config opencv --cflags --libs`
...
g++ -std=c++11 extApi.o extApiPlatform.o vrephal.o vrephaltest2.o -o vrephaltest2 -lpthread `pkg-config opencv --cflags --libs`
